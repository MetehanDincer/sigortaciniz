...
import { Phone, Mail, MapPin, CheckCircle2, Menu } from "lucide-react"
...
export function ContactContent({ agency }: { agency?: any }) {
    ...
    const email = agency?.support_email || "info@uygunsigortaci.com"
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
                        <div className="flex flex-col items-center text-center">
                            ...
                            <p className="text-muted-foreground text-lg mb-8 leading-relaxed max-w-md">
                                {agency?.name || 'Sigorta'} ihtiyaçlarınız için uzman ekibimizle her zaman yanınızdayız. Sorularınız, teklif talepleriniz veya görüşleriniz için aşağıdaki kanallardan bize ulaşabilirsiniz.
                            </p>
                            ...
                            <div className="space-y-8 w-full">
                                <div className="flex flex-col items-center gap-3 p-6 rounded-2xl bg-muted/30 hover:bg-muted/50 transition-colors">
                                    ...
                                    <div>
                                        ...
                                        <a href={`tel:${phoneNumber}`} className="text-muted-foreground hover:text-primary transition-colors text-lg font-medium">
                                            {agency?.whatsapp_number || defaultPhone}
                                        </a>
                                ...
                                <div className="flex flex-col items-center gap-3 p-6 rounded-2xl bg-muted/30 hover:bg-muted/50 transition-colors">
                                    ...
                                    <div>
                                        ...
                                        <a href={`mailto:${email}`} className="text-muted-foreground hover:text-primary transition-colors text-lg font-medium">
                                            {email}
                                        </a>
                                ...
                                <div className="flex flex-col items-center gap-3 p-6 rounded-2xl bg-muted/30 hover:bg-muted/50 transition-colors">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-muted-foreground text-lg leading-relaxed whitespace-pre-wrap">
                                            {agency?.address || "Meşrutiyet Mah. Rumeli Cad. Konfor Çarşısı\nNo:40 İç Kapı No:47\nNişantaşı / Şişli / İstanbul"}
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="bg-card border rounded-2xl p-8 shadow-sm">
                            ...
                            <div className="mt-12 pt-8 border-t flex flex-col items-center justify-center opacity-30 group hover:opacity-100 transition-opacity duration-500">
                                ...
                                <span className="mt-4 text-3xl font-bold text-muted-foreground/60 group-hover:text-primary transition-colors duration-500">
                                    {name}<span className="text-primary group-hover:text-foreground">.</span>com
                                </span>
                            </div>
                        </div>
                    </div>
