    ...
    async function onSubmit(data: FormValues) {
        ...
        try {
            ...
            const response = await fetch("/api/contact", {
                ...
                body: JSON.stringify({ type: "Özel Sağlık Sigortası", ...data }),
            })
            ...
            const message = `Merhaba, Özel Sağlık Sigortası teklifi almak istiyorum:\n\n` +
                `🆔 TC: ${data.tcNumber}\n` +
        ...
        return (
            <div className="flex min-h-screen flex-col items-center justify-center p-4 text-center">
                ...
                <p className="mb-8 max-w-md text-muted-foreground">
                    Özel sağlık sigortası talebiniz bize ulaştı. En kısa sürede sizinle iletişime geçeceğiz.
                </p>
                <Button asChild>
                ...
                <div className="container max-w-md px-4 mx-auto">
                    <div className="rounded-xl border bg-card p-8 shadow-sm">
                        <div className="mb-8 flex flex-col items-center text-center">
                            ...
                            <h1 className="text-2xl font-bold">Özel Sağlık Sigortası</h1>
