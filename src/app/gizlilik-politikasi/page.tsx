                    ...
                    <div className="bg-card rounded-3xl border shadow-sm p-8 md:p-12">
                        ...
                        <div className="prose prose-lg dark:prose-invert max-w-none text-muted-foreground leading-relaxed space-y-8">
                            ...
                            <section>
                                ...
                                <div className="space-y-6">
                                    <div>
                                        ...
                                        <p>
                                            Sizin web sitemizi kullanarak veya e-posta, faks gibi diğer yollarla bize sağladığınız bilgiler tarafımızdan alınmakta ve kaydedilmektedir. Bu yolla elde edilen bilgiler tamamen özgür iradenizle tarafımıza sağladığınız bilgilerdir. Bu bilgileri bize verip vermemekte serbestsiniz ancak size daha çabuk, doğru, etkili ve kaliteli hizmet sunabilmemiz için web sitemizde sizden talep edilen bilgilerin tamamını vermenizi öneriyoruz. Ayrıca talep ettiğiniz hizmetin gerektirdiği zorunlu bilgileri vermemeniz durumunda talebinizin yerine getirilmesinin mümkün olamayacağı tarafınızdan dikkate alınmalıdır. Verdiğiniz bilgilerin doğru ve eksiksiz olması sizin sorumluluğunuzdadır. Yanlış, yanıltıcı veya eksik bilgi vermeyiniz. Yanlış, yanıltıcı veya eksik bilgi verilmesi veya beyanlarda bulunulması, talep ettiğiniz sigortanın geçerliliğini, bizim ve/veya sigorta şirketinin size ve/veya sigortalıya karşı olan sorumluluklarını ve poliçeye dayalı sigorta tazminatı talep haklarını etkileyebilir. Böyle bir durumda UygunSigortaci.com hiçbir sorumluluk kabul etmez. Yanlış, yanıltıcı veya eksik bilgi vermeniz nedeniyle UygunSigortaci.com bir zarara uğradığı takdirde bu zararı tazmin yükümlülüğü tarafınıza aittir.
                                        </p>
                                    </div>
                            ...
                            <section>
                                ...
                                <p>
                                    ‘Gizlilik Politikası‘ ve ‘Kullanıcı Sözleşmesi‘ bölümlerindeki hükümler ve bu hükümlerde UygunSigortaci.com tarafından zaman zaman yapılan değişiklikler, UygunSigortaci.com ile sizin aranızda kurulan hukuki ilişkinin tamamını oluşturur ve tarafları bağlar. Aksi yazılı olarak ayrıca kararlaştırılmadıkça UygunSigortaci.com’e karşı bu hükümlere aykırı hiçbir talepte bulunulamaz ve hak ileri sürülemez.
                                </p>
                            </section>
                        </div>
                    </div>
